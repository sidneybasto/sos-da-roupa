...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("cupom_form") . "/cupom_form_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cupom_form']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['cupom_form'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("pdfreport_qrcodes") . "/pdfreport_qrcodes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['pdfreport_qrcodes']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['pdfreport_qrcodes'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("reimpressao_form_qrcodes") . "/reimpressao_form_qrcodes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reimpressao_form_qrcodes']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['reimpressao_form_qrcodes'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("vendedores_grid") . "/vendedores_grid_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['vendedores_grid']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['vendedores_grid'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("sair") . "/sair_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sair']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['sair'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['cupom_form']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cupom_form']) == "on")
{
    $menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=cupom_form&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['pdfreport_qrcodes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['pdfreport_qrcodes']) == "on")
{
    $menu_menuData['data'] .= "item_4|.|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=pdfreport_qrcodes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_4|.|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_6|.|" . $nm_var_lab[2] . "||" . $nm_var_hint[2] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['reimpressao_form_qrcodes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['reimpressao_form_qrcodes']) == "on")
{
    $menu_menuData['data'] .= "item_7|..|" . $nm_var_lab[3] . "|menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=reimpressao_form_qrcodes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_7|..|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['vendedores_grid']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['vendedores_grid']) == "on")
{
    $menu_menuData['data'] .= "item_2|..|" . $nm_var_lab[4] . "|menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=vendedores_grid&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_2|..|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sair']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sair']) == "on")
{
    $menu_menuData['data'] .= "item_5|.|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=sair&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_parent') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_5|.|" . $nm_var_lab[5] . "||||_parent|disabled\n";
}

$menu_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=cupom_form&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cupom_form']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['cupom_form']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=pdfreport_qrcodes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['pdfreport_qrcodes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['pdfreport_qrcodes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=reimpressao_form_qrcodes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['reimpressao_form_qrcodes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['reimpressao_form_qrcodes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=vendedores_grid&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['vendedores_grid']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['vendedores_grid']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=sair&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sair']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sair']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuHHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "SOS DA ROUPA" ?></div>
    <div class="scMenuHHeaderFont" style="float: right;"><?php echo "V.1.2" ?></div>
</div>    </td>
  </tr>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    if (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_sos_da_roupa.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_sos_da_roupa.txt"));
