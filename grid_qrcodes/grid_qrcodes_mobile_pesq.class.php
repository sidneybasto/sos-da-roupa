...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "ticket";$Nm_numeric[] = "vendedor";$Nm_numeric[] = "qtde_cupons";$Nm_numeric[] = "id";$Nm_numeric[] = "ticket";$Nm_numeric[] = "vendedor";$Nm_numeric[] = "qtde_cupons";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_ticket_cond" name="ticket_cond" onChange="nm_campos_between(document.getElementById('id_vis_ticket'), this, 'ticket')">
       <OPTION value="eq" <?php if ("eq" == $ticket_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_ticket"  <?php echo $str_hide_ticket?>><?php
      if ($ticket != "")
      {
      $ticket_look = substr($this->Db->qstr($ticket), 1, -1); 
      $nmgp_def_dados = array(); 
