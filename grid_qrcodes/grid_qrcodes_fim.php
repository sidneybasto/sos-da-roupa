...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sos_da_roupa_____grid_qrcodes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sos_da_roupa_____grid_qrcodes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_qrcodes']['embutida_filho'] as $ind => $sc_init)
          {
