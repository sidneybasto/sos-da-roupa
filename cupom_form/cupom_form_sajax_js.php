  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cupom_form" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate ticket
  function do_ajax_cupom_form_validate_ticket()
  {
    var nomeCampo_ticket = "ticket";
    var var_ticket = scAjaxGetFieldText(nomeCampo_ticket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_ticket(var_ticket, var_script_case_init, do_ajax_cupom_form_validate_ticket_cb);
  } // do_ajax_cupom_form_validate_ticket

  function do_ajax_cupom_form_validate_ticket_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_ticket_cb

  // ---------- Validate valor
  function do_ajax_cupom_form_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_valor(var_valor, var_script_case_init, do_ajax_cupom_form_validate_valor_cb);
  } // do_ajax_cupom_form_validate_valor

  function do_ajax_cupom_form_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_valor_cb

  // ---------- Validate cliente
  function do_ajax_cupom_form_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldText(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_cliente(var_cliente, var_script_case_init, do_ajax_cupom_form_validate_cliente_cb);
  } // do_ajax_cupom_form_validate_cliente

  function do_ajax_cupom_form_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_cliente_cb

  // ---------- Validate telefone
  function do_ajax_cupom_form_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_telefone(var_telefone, var_script_case_init, do_ajax_cupom_form_validate_telefone_cb);
  } // do_ajax_cupom_form_validate_telefone

  function do_ajax_cupom_form_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_telefone_cb

  // ---------- Validate email
  function do_ajax_cupom_form_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_email(var_email, var_script_case_init, do_ajax_cupom_form_validate_email_cb);
  } // do_ajax_cupom_form_validate_email

  function do_ajax_cupom_form_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_email_cb

  // ---------- Validate vendedor
  function do_ajax_cupom_form_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldSelect(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_cupom_form_validate_vendedor_cb);
  } // do_ajax_cupom_form_validate_vendedor

  function do_ajax_cupom_form_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_vendedor_cb

  // ---------- Validate imprimir
  function do_ajax_cupom_form_validate_imprimir()
  {
    var nomeCampo_imprimir = "imprimir";
    var var_imprimir = scAjaxGetFieldText(nomeCampo_imprimir);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_imprimir(var_imprimir, var_script_case_init, do_ajax_cupom_form_validate_imprimir_cb);
  } // do_ajax_cupom_form_validate_imprimir

  function do_ajax_cupom_form_validate_imprimir_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_imprimir_cb

  // ---------- Validate qtde_cupons
  function do_ajax_cupom_form_validate_qtde_cupons()
  {
    var nomeCampo_qtde_cupons = "qtde_cupons";
    var var_qtde_cupons = scAjaxGetFieldText(nomeCampo_qtde_cupons);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cupom_form_validate_qtde_cupons(var_qtde_cupons, var_script_case_init, do_ajax_cupom_form_validate_qtde_cupons_cb);
  } // do_ajax_cupom_form_validate_qtde_cupons

  function do_ajax_cupom_form_validate_qtde_cupons_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cupom_form_validate_qtde_cupons_cb
  // ---------- Form
  function do_ajax_cupom_form_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cupom_form_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_cupom_form_submit_form(var_ticket, var_valor, var_cliente, var_telefone, var_email, var_vendedor, var_imprimir, var_qtde_cupons, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cupom_form_submit_form_cb);
  } // do_ajax_cupom_form_submit_form

  function do_ajax_cupom_form_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_cupom_form_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_cupom_form_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_cupom_form_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_cupom_form_navigate_form_cb);
  } // do_ajax_cupom_form_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cupom_form']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cupom_form_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_cupom_form_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cupom_form_navigate_form_cb
  function sc_hide_cupom_form_form()
  {
