...
$old_error_handler = set_error_handler("cupom_form_scriptcase_error_handler");

function cupom_form_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['cupom_form']['contr_erro']) && $_SESSION['scriptcase']['cupom_form']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_cupom_form->contr_cupom_form->Apl_com_erro = true;
            if ($inicial_cupom_form->contr_cupom_form->NM_ajax_flag)
            {
                $inicial_cupom_form->contr_cupom_form->NM_ajax_info['errList']['geral_cupom_form'][] = $msg;
                return;
            }
            cupom_form_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function cupom_form_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['cupom_form'])  && '' != $_SESSION['scriptcase']['error_icon']['cupom_form'])  ? $_SESSION['scriptcase']['error_icon']['cupom_form']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['cupom_form']) && '' != $_SESSION['scriptcase']['error_close']['cupom_form']) ? $_SESSION['scriptcase']['error_close']['cupom_form'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['cupom_form']) && '' != $_SESSION['scriptcase']['error_span_title']['cupom_form']) ? $_SESSION['scriptcase']['error_span_title']['cupom_form'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['cupom_form']) && '' != $_SESSION['scriptcase']['error_icon_title']['cupom_form']) ? $_SESSION['scriptcase']['error_icon_title']['cupom_form'] : '';
?>
