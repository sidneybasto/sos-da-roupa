...
<?php
   ...
   $Ord_Cmp = new vendedores_grid_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class vendedores_grid_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['vendedores_grid']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['vendedores_grid']['labels']["id"] : "Id";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "Vendedor";
   $tab_converte["Vendedor"]   = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['vendedores_grid']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['vendedores_grid']['labels']["vendedor"] : "Vendedor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['vendedores_grid']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['vendedores_grid']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['vendedores_grid']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "vendedores_grid_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['vendedores_grid']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
