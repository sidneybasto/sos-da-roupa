...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_vendedor_cond" name="vendedor_cond" onChange="nm_campos_between(document.getElementById('id_vis_vendedor'), this, 'vendedor')">
      ...
      <br><span id="id_hide_vendedor"  <?php echo $str_hide_vendedor?>><INPUT  type="text" id="SC_vendedor" name="vendedor" value="<?php echo NM_encode_input($vendedor) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
