 ...
 */
    ...
    $SC_cod_proj = "sos_da_roupa";
    $SC_apl_proc = "vendedores_grid";
/* sc_apl_default */
...
$isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['vendedores_grid']['summarizing_drill_down']);
$isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['vendedores_grid']['graf_opc_atual'];

  $sDisplay = !isset($_SESSION['sc_session']['vendedores_grid']['show_skip_charts_option']) ||
             !$_SESSION['sc_session']['vendedores_grid']['show_skip_charts_option'] ||
             (isset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['vendedores_grid']['SC_Ind_Groupby']) ||
             $isMultiSeriesChart ||
             $isAnalitic ||
             ($opc == 'pdf_det')
             ? ' style="display: none"' : '';
...
{
 $sDisplay =
            !isset($_SESSION['sc_session']['vendedores_grid']['show_skip_charts_option']) ||
            !$_SESSION['sc_session']['vendedores_grid']['show_skip_charts_option'] ||
            $isMultiSeriesChart ||
            $isAnalitic ||
             ($opc == 'pdf_det')
