...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["sos_da_roupa_____vendedores_grid"]))
   {
      unset($_SESSION['session_sec_aplicacao']["sos_da_roupa_____vendedores_grid"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['vendedores_form'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['vendedores_grid']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['vendedores_grid']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['vendedores_grid']['embutida_filho'] as $ind => $sc_init)
          {
