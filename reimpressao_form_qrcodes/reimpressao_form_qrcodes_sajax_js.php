  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_reimpressao_form_qrcodes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_reimpressao_form_qrcodes_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_reimpressao_form_qrcodes_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_reimpressao_form_qrcodes_validate_id__cb);
  } // do_ajax_reimpressao_form_qrcodes_validate_id_

  function do_ajax_reimpressao_form_qrcodes_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_reimpressao_form_qrcodes_validate_id__cb

  // ---------- Validate ticket_
  function do_ajax_reimpressao_form_qrcodes_validate_ticket_(iNumLinha)
  {
    var nomeCampo_ticket_ = "ticket_" + iNumLinha;
    var var_ticket_ = scAjaxGetFieldText(nomeCampo_ticket_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_reimpressao_form_qrcodes_validate_ticket_(var_ticket_, iNumLinha, var_script_case_init, do_ajax_reimpressao_form_qrcodes_validate_ticket__cb);
  } // do_ajax_reimpressao_form_qrcodes_validate_ticket_

  function do_ajax_reimpressao_form_qrcodes_validate_ticket__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ticket_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ticket_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ticket_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ticket_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_reimpressao_form_qrcodes_validate_ticket__cb

  // ---------- Validate cliente_
  function do_ajax_reimpressao_form_qrcodes_validate_cliente_(iNumLinha)
  {
    var nomeCampo_cliente_ = "cliente_" + iNumLinha;
    var var_cliente_ = scAjaxGetFieldText(nomeCampo_cliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_reimpressao_form_qrcodes_validate_cliente_(var_cliente_, iNumLinha, var_script_case_init, do_ajax_reimpressao_form_qrcodes_validate_cliente__cb);
  } // do_ajax_reimpressao_form_qrcodes_validate_cliente_

  function do_ajax_reimpressao_form_qrcodes_validate_cliente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_reimpressao_form_qrcodes_validate_cliente__cb

  // ---------- Validate vendedor_
  function do_ajax_reimpressao_form_qrcodes_validate_vendedor_(iNumLinha)
  {
    var nomeCampo_vendedor_ = "vendedor_" + iNumLinha;
    var var_vendedor_ = scAjaxGetFieldText(nomeCampo_vendedor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_reimpressao_form_qrcodes_validate_vendedor_(var_vendedor_, iNumLinha, var_script_case_init, do_ajax_reimpressao_form_qrcodes_validate_vendedor__cb);
  } // do_ajax_reimpressao_form_qrcodes_validate_vendedor_

  function do_ajax_reimpressao_form_qrcodes_validate_vendedor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_reimpressao_form_qrcodes_validate_vendedor__cb

  // ---------- Validate imprimir_
  function do_ajax_reimpressao_form_qrcodes_validate_imprimir_(iNumLinha)
  {
    var nomeCampo_imprimir_ = "imprimir_" + iNumLinha;
    var var_imprimir_ = scAjaxGetFieldText(nomeCampo_imprimir_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_reimpressao_form_qrcodes_validate_imprimir_(var_imprimir_, iNumLinha, var_script_case_init, do_ajax_reimpressao_form_qrcodes_validate_imprimir__cb);
  } // do_ajax_reimpressao_form_qrcodes_validate_imprimir_

  function do_ajax_reimpressao_form_qrcodes_validate_imprimir__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "imprimir_" + iLineNumber;
    }
    else
    {
      sFieldValid = "imprimir_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "imprimir_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "imprimir_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_reimpressao_form_qrcodes_validate_imprimir__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_reimpressao_form_qrcodes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_reimpressao_form_qrcodes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_reimpressao_form_qrcodes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_reimpressao_form_qrcodes_add_new_line_cb);
  } // do_ajax_reimpressao_form_qrcodes_add_new_line

  function do_ajax_reimpressao_form_qrcodes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_reimpressao_form_qrcodes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_reimpressao_form_qrcodes_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_reimpressao_form_qrcodes_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_reimpressao_form_qrcodes_backup_line_cb);
  } // do_ajax_reimpressao_form_qrcodes_backup_line

  function do_ajax_reimpressao_form_qrcodes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_reimpressao_form_qrcodes_backup_line_cb

  function do_ajax_reimpressao_form_qrcodes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_reimpressao_form_qrcodes_cancel_insert

  function do_ajax_reimpressao_form_qrcodes_cancel_update(iSeqVert)
  {
    do_ajax_reimpressao_form_qrcodes_backup_line(iSeqVert);
...
?>
  } // do_ajax_reimpressao_form_qrcodes_cancel_update

  function do_ajax_reimpressao_form_qrcodes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_reimpressao_form_qrcodes_restore_buttons

  // ---------- table_refresh
  function do_ajax_reimpressao_form_qrcodes_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_reimpressao_form_qrcodes_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_reimpressao_form_qrcodes_table_refresh_cb);
  } //  do_ajax_reimpressao_form_qrcodes_table_refresh

  function do_ajax_reimpressao_form_qrcodes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    sc_insert_open = false;
  } // do_ajax_reimpressao_form_qrcodes_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_reimpressao_form_qrcodes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_reimpressao_form_qrcodes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_ticket_ = scAjaxGetFieldText("ticket_" + iNumLinha);
    var var_cliente_ = scAjaxGetFieldText("cliente_" + iNumLinha);
    var var_vendedor_ = scAjaxGetFieldText("vendedor_" + iNumLinha);
    var var_imprimir_ = scAjaxGetFieldText("imprimir_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_reimpressao_form_qrcodes_submit_form(var_id_, var_ticket_, var_cliente_, var_vendedor_, var_imprimir_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_reimpressao_form_qrcodes_submit_form_cb);
  } // do_ajax_reimpressao_form_qrcodes_submit_form

  function do_ajax_reimpressao_form_qrcodes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_reimpressao_form_qrcodes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_reimpressao_form_qrcodes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_reimpressao_form_qrcodes_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_reimpressao_form_qrcodes_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_reimpressao_form_qrcodes_navigate_form_cb);
  } // do_ajax_reimpressao_form_qrcodes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['reimpressao_form_qrcodes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_reimpressao_form_qrcodes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
?>
  ...
  } // do_ajax_reimpressao_form_qrcodes_navigate_form_cb
  function sc_hide_reimpressao_form_qrcodes_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_reimpressao_form_qrcodes_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["ticket_" + iNumLinha] = {"label": "Ticket<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["imprimir_" + iNumLinha] = {"label": "Imprimir<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["ticket_"][iNumLinha] = "ticket_" + iNumLinha;
    ajax_field_mult["cliente_"][iNumLinha] = "cliente_" + iNumLinha;
    ajax_field_mult["vendedor_"][iNumLinha] = "vendedor_" + iNumLinha;
    ajax_field_mult["imprimir_"][iNumLinha] = "imprimir_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["ticket_" + iNumLinha] = new Array("hidden_field_label_ticket_", "hidden_field_data_ticket_" + iNumLinha);
    ...
    ajax_field_id["imprimir_" + iNumLinha] = new Array("hidden_field_label_imprimir_", "hidden_field_data_imprimir_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["ticket_" + iNumLinha] = "off";
    ajax_error_count["cliente_" + iNumLinha] = "off";
    ajax_error_count["vendedor_" + iNumLinha] = "off";
    ajax_error_count["imprimir_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["ticket_" + iNumLinha] = "on";
    ajax_read_only["cliente_" + iNumLinha] = "on";
    ajax_read_only["vendedor_" + iNumLinha] = "off";
    ajax_read_only["imprimir_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["imprimir_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["ticket_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ticket_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ticket_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ticket_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ticket_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["imprimir_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["imprimir_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["imprimir_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["imprimir_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["imprimir_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ticket_'])) ? $this->nmgp_cmp_readonly['ticket_'] : 'on';
?>
    scAjaxFieldRead("ticket_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cliente_'])) ? $this->nmgp_cmp_readonly['cliente_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['imprimir_'])) ? $this->nmgp_cmp_readonly['imprimir_'] : 'off';
?>
    scAjaxFieldRead("imprimir_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("ticket_" + iSeq, "on");
    scAjaxFieldRead("cliente_" + iSeq, "on");
    scAjaxFieldRead("vendedor_" + iSeq, "on");
    scAjaxFieldRead("imprimir_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["ticket_" + iRow] || "on" == ajax_error_count["cliente_" + iRow] || "on" == ajax_error_count["vendedor_" + iRow] || "on" == ajax_error_count["imprimir_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["ticket_" + iRow] && "off" == ajax_error_count["cliente_" + iRow] && "off" == ajax_error_count["vendedor_" + iRow] && "off" == ajax_error_count["imprimir_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["ticket_" + iRow] = "off";
        ajax_error_count["cliente_" + iRow] = "off";
        ajax_error_count["vendedor_" + iRow] = "off";
        ajax_error_count["imprimir_" + iRow] = "off";
      }
