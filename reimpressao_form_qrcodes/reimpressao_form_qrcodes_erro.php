...
$old_error_handler = set_error_handler("reimpressao_form_qrcodes_scriptcase_error_handler");

function reimpressao_form_qrcodes_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['reimpressao_form_qrcodes']['contr_erro']) && $_SESSION['scriptcase']['reimpressao_form_qrcodes']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_reimpressao_form_qrcodes->contr_reimpressao_form_qrcodes->Apl_com_erro = true;
            if ($inicial_reimpressao_form_qrcodes->contr_reimpressao_form_qrcodes->NM_ajax_flag)
            {
                $inicial_reimpressao_form_qrcodes->contr_reimpressao_form_qrcodes->NM_ajax_info['errList']['geral_reimpressao_form_qrcodes'][] = $msg;
                return;
            }
            reimpressao_form_qrcodes_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function reimpressao_form_qrcodes_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['reimpressao_form_qrcodes'])  && '' != $_SESSION['scriptcase']['error_icon']['reimpressao_form_qrcodes'])  ? $_SESSION['scriptcase']['error_icon']['reimpressao_form_qrcodes']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['reimpressao_form_qrcodes']) && '' != $_SESSION['scriptcase']['error_span_title']['reimpressao_form_qrcodes']) ? $_SESSION['scriptcase']['error_span_title']['reimpressao_form_qrcodes'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['reimpressao_form_qrcodes']) && '' != $_SESSION['scriptcase']['error_icon_title']['reimpressao_form_qrcodes']) ? $_SESSION['scriptcase']['error_icon_title']['reimpressao_form_qrcodes'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['reimpressao_form_qrcodes']['error_buffer'] .= ob_get_flush();
}
