  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_vendedores_form" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_vendedores_form_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_vendedores_form_validate_id(var_id, var_script_case_init, do_ajax_vendedores_form_validate_id_cb);
  } // do_ajax_vendedores_form_validate_id

  function do_ajax_vendedores_form_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_vendedores_form_validate_id_cb

  // ---------- Validate vendedor
  function do_ajax_vendedores_form_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldText(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_vendedores_form_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_vendedores_form_validate_vendedor_cb);
  } // do_ajax_vendedores_form_validate_vendedor

  function do_ajax_vendedores_form_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_vendedores_form_validate_vendedor_cb
  // ---------- Form
  function do_ajax_vendedores_form_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_vendedores_form_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_vendedores_form_submit_form(var_id, var_vendedor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_vendedores_form_submit_form_cb);
  } // do_ajax_vendedores_form_submit_form

  function do_ajax_vendedores_form_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_vendedores_form_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_vendedores_form_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_vendedores_form_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_vendedores_form_navigate_form_cb);
  } // do_ajax_vendedores_form_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['vendedores_form']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_vendedores_form_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_vendedores_form_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_vendedores_form_navigate_form_cb
  function sc_hide_vendedores_form_form()
  {
