...
$old_error_handler = set_error_handler("vendedores_form_mob_scriptcase_error_handler");

function vendedores_form_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['vendedores_form_mob']['contr_erro']) && $_SESSION['scriptcase']['vendedores_form_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_vendedores_form_mob->contr_vendedores_form_mob->Apl_com_erro = true;
            if ($inicial_vendedores_form_mob->contr_vendedores_form_mob->NM_ajax_flag)
            {
                $inicial_vendedores_form_mob->contr_vendedores_form_mob->NM_ajax_info['errList']['geral_vendedores_form_mob'][] = $msg;
                return;
            }
            vendedores_form_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function vendedores_form_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['vendedores_form_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['vendedores_form_mob'])  ? $_SESSION['scriptcase']['error_icon']['vendedores_form_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['vendedores_form_mob']) && '' != $_SESSION['scriptcase']['error_close']['vendedores_form_mob']) ? $_SESSION['scriptcase']['error_close']['vendedores_form_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['vendedores_form_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['vendedores_form_mob']) ? $_SESSION['scriptcase']['error_span_title']['vendedores_form_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['vendedores_form_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['vendedores_form_mob']) ? $_SESSION['scriptcase']['error_icon_title']['vendedores_form_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['vendedores_form']['error_buffer'] .= ob_get_flush();
}
